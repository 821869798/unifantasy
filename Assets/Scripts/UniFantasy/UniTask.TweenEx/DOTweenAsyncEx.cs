...
namespace Cysharp.Threading.Tasks
{
    ...
    public static class DOTweenAsyncEx
    {
        enum CallbackType
        {
            Kill,
        ...
        sealed class TweenConfiguredSource : IUniTaskSource, ITaskPoolNode<TweenConfiguredSource>
        {
            ...
            readonly TweenCallback onCancelCallbackDelegate;
            ...
            TweenCallback originalKillAction;
            ...
            public static IUniTaskSource Create(Tween tween, TweenCancelBehaviour cancelBehaviour, CancellationToken cancellationToken, CallbackType callbackType, out short token)
            {
                ...
                switch (callbackType)
                {
                    ...
                    case CallbackType.Complete:
                        ...
                        result.originalKillAction = tween.onKill;
                        tween.onKill = result.onCancelCallbackDelegate;
                        break;
                ...
                if (result.originalKillAction == result.onCancelCallbackDelegate)
                {
                    result.originalKillAction = null;
                }
            ...
            void RestoreOriginalCallback()
            {
                switch (callbackType)
                {
                    ...
                    case CallbackType.Complete:
                        ...
                        tween.onKill = originalKillAction;
                        break;
                    case CallbackType.Pause:
